...
_lr_productions = [
  ...
  ('expr_funcion -> NAME LPAREN params RPAREN','expr_funcion',4,'p_expr_funcion','PythonPlag.py',125),
  ('expr_funcion -> NAME LPAREN RPAREN','expr_funcion',3,'p_expr_funcion','PythonPlag.py',126),
  ('params -> variable','params',1,'p_params','PythonPlag.py',130),
  ('params -> params COMA variable','params',3,'p_params','PythonPlag.py',131),
  ('params -> expr_funcion','params',1,'p_params','PythonPlag.py',132),
  ('variable -> NAME','variable',1,'p_variable','PythonPlag.py',136),
  ('variable -> expr_str','variable',1,'p_variable','PythonPlag.py',137),
  ('variable -> NUMBER','variable',1,'p_variable','PythonPlag.py',138),
  ('variable -> expr_float','variable',1,'p_variable','PythonPlag.py',139),
  ('variable -> bool','variable',1,'p_variable','PythonPlag.py',140),
  ('variable -> lista','variable',1,'p_variable','PythonPlag.py',141),
  ('lista -> NAME LCORC variable RCORC','lista',4,'p_lista','PythonPlag.py',145),
  ('lista -> NAME LCORC RCORC','lista',3,'p_lista','PythonPlag.py',146),
  ('lista -> NAME LCORC operaciones_algebraica RCORC','lista',4,'p_lista','PythonPlag.py',147),
  ('expr_str -> STRING','expr_str',1,'p_expr_str','PythonPlag.py',151),
  ('expr_float -> NUMBER PUNTO NUMBER','expr_float',3,'p_expr_float','PythonPlag.py',155),
  ('expr_def_funcion -> DEF expr_funcion DPUNTOS','expr_def_funcion',3,'p_expr_def_funcion','PythonPlag.py',159),
